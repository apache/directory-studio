...
public final class PluginConstants
{
    ...
    // Images
    public static final String IMG_ATTRIBUTE_TYPE = "resources/icons/attribute_type.png"; //$NON-NLS-1$
    public static final String IMG_ATTRIBUTE_TYPE_HIERARCHY_SELECTED = "resources/icons/attribute_type_hierarchy_selected.png"; //$NON-NLS-1$
    public static final String IMG_ATTRIBUTE_TYPE_NEW = "resources/icons/attribute_type_new.png"; //$NON-NLS-1$
    public static final String IMG_ATTRIBUTE_TYPE_NEW_WIZARD = "resources/icons/attribute_type_new_wizard.png"; //$NON-NLS-1$
    public static final String IMG_ATTRIBUTE_TYPE_OVERLAY_OPERATION = "resources/icons/attribute_type_overlay_operation.png"; //$NON-NLS-1$
    public static final String IMG_ATTRIBUTE_TYPE_OVERLAY_USER_APPLICATION = "resources/icons/attribute_type_overlay_userApplication.png"; //$NON-NLS-1$
    public static final String IMG_CONNECT = "resources/icons/connect.png"; //$NON-NLS-1$
    public static final String IMG_COMMIT_CHANGES = "resources/icons/commit_changes.png"; //$NON-NLS-1$
    public static final String IMG_COMMIT_CHANGES_WIZARD = "resources/icons/commit_changes_wizard.png"; //$NON-NLS-1$
    public static final String IMG_COLLAPSE_ALL = "resources/icons/collapse_all.png"; //$NON-NLS-1$
    public static final String IMG_DELETE = "resources/icons/delete.png"; //$NON-NLS-1$
    public static final String IMG_DISCONNECT = "resources/icons/disconnect.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_ATTRIBUTE_TYPE_ADD = "resources/icons/difference_attribute_type_add.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_ATTRIBUTE_TYPE_MODIFY = "resources/icons/difference_attribute_type_modify.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_ATTRIBUTE_TYPE_REMOVE = "resources/icons/difference_attribute_type_remove.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_OBJECT_CLASS_ADD = "resources/icons/difference_object_class_add.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_OBJECT_CLASS_MODIFY = "resources/icons/difference_object_class_modify.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_OBJECT_CLASS_REMOVE = "resources/icons/difference_object_class_remove.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_PROPERTY_ADD = "resources/icons/difference_property_add.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_PROPERTY_MODIFY = "resources/icons/difference_property_modify.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_PROPERTY_REMOVE = "resources/icons/difference_property_remove.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_SCHEMA_ADD = "resources/icons/difference_schema_add.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_SCHEMA_MODIFY = "resources/icons/difference_schema_modify.png"; //$NON-NLS-1$
    public static final String IMG_DIFFERENCE_SCHEMA_REMOVE = "resources/icons/difference_schema_remove.png"; //$NON-NLS-1$
    public static final String IMG_FOLDER = "resources/icons/folder.png"; //$NON-NLS-1$
    public static final String IMG_FOLDER_AT = "resources/icons/folder_at.png"; //$NON-NLS-1$
    public static final String IMG_FOLDER_OC = "resources/icons/folder_oc.png"; //$NON-NLS-1$
    ...
    public static final String IMG_OBJECT_CLASS_HIERARCHY_SELECTED = "resources/icons/object_class_hierarchy_selected.png"; //$NON-NLS-1$
    public static final String IMG_OBJECT_CLASS_NEW = "resources/icons/object_class_new.png"; //$NON-NLS-1$
    public static final String IMG_OBJECT_CLASS_NEW_WIZARD = "resources/icons/object_class_new_wizard.png"; //$NON-NLS-1$
    public static final String IMG_OBJECT_CLASS_OVERLAY_ABSTRACT = "resources/icons/object_class_overlay_abstract.png"; //$NON-NLS-1$
    public static final String IMG_OBJECT_CLASS_OVERLAY_AUXILIARY = "resources/icons/object_class_overlay_auxiliary.png"; //$NON-NLS-1$
    public static final String IMG_OBJECT_CLASS_OVERLAY_STRUCTURAL = "resources/icons/object_class_overlay_structural.png"; //$NON-NLS-1$
    public static final String IMG_OVERLAY_ERROR = "resources/icons/overlay_error.png"; //$NON-NLS-1$
    public static final String IMG_OVERLAY_WARNING = "resources/icons/overlay_warning.png"; //$NON-NLS-1$
    public static final String IMG_PROBLEMS_ERROR = "resources/icons/problems_error.png"; //$NON-NLS-1$
    public static final String IMG_PROBLEMS_GROUP = "resources/icons/problems_group.png"; //$NON-NLS-1$
    public static final String IMG_PROBLEMS_WARNING = "resources/icons/problems_warning.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_EXPORT = "resources/icons/project_export.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_EXPORT_WIZARD = "resources/icons/project_export_wizard.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_FILE = "resources/icons/project_file.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_IMPORT = "resources/icons/project_import.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_IMPORT_WIZARD = "resources/icons/project_import_wizard.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_NEW = "resources/icons/project_new.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_NEW_WIZARD = "resources/icons/project_new_wizard.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_OFFLINE = "resources/icons/project_offline.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_OFFLINE_CLOSED = "resources/icons/project_offline_closed.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_ONLINE = "resources/icons/project_online.png"; //$NON-NLS-1$
    public static final String IMG_PROJECT_ONLINE_CLOSED = "resources/icons/project_online_closed.png"; //$NON-NLS-1$
    public static final String IMG_RENAME = "resources/icons/rename.png"; //$NON-NLS-1$
    public static final String IMG_RUN_CURRENT_SEARCH_AGAIN = "resources/icons/run_current_search_again.png"; //$NON-NLS-1$
    public static final String IMG_SCHEMA = "resources/icons/schema.png"; //$NON-NLS-1$
    public static final String IMG_SCHEMA_CONNECTOR = "resources/icons/schema_connector.png"; //$NON-NLS-1$
    public static final String IMG_SCHEMA_NEW = "resources/icons/schema_new.png"; //$NON-NLS-1$
    public static final String IMG_SCHEMA_NEW_WIZARD = "resources/icons/schema_new_wizard.png"; //$NON-NLS-1$
    public static final String IMG_SCHEMAS_EXPORT = "resources/icons/schemas_export.png"; //$NON-NLS-1$
    public static final String IMG_SCHEMAS_EXPORT_FOR_ADS = "resources/icons/schemas_export_for_ads.png"; //$NON-NLS-1$
    ...
    public static final String IMG_SCHEMAS_IMPORT = "resources/icons/schemas_import.png"; //$NON-NLS-1$
    ...
    public static final String IMG_SEARCH_HISTORY_ITEM = "resources/icons/search_history_item.png"; //$NON-NLS-1$
    public static final String IMG_SHOW_SEARCH_FIELD = "resources/icons/show_search_field.png"; //$NON-NLS-1$
    public static final String IMG_SHOW_SEARCH_HISTORY = "resources/icons/show_search_history.png"; //$NON-NLS-1$
    ...
    public static final String IMG_SHOW_TYPE_HIERARCHY = "resources/icons/hierarchy_type.png"; //$NON-NLS-1$
    public static final String IMG_SORTING = "resources/icons/sorting.png"; //$NON-NLS-1$
    public static final String IMG_TOOLBAR_MENU = "resources/icons/toolbar_menu.png"; //$NON-NLS-1$
    public static final String IMG_TRANSPARENT_16X16 = "resources/icons/transparent_16x16.png"; //$NON-NLS-1$
