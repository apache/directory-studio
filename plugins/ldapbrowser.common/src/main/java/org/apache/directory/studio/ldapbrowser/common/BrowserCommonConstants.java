...
public final class BrowserCommonConstants
{
    ...
    public static final String IMG_HEXEDITOR = "resources/icons/hexeditor.png"; //$NON-NLS-1$
    public static final String IMG_TEXTEDITOR = "resources/icons/texteditor.png"; //$NON-NLS-1$
    public static final String IMG_INPLACE_TEXTEDITOR = "resources/icons/inplace_texteditor.png"; //$NON-NLS-1$
    public static final String IMG_MULTIVALUEDEDITOR = "resources/icons/multivaluededitor.png"; //$NON-NLS-1$
    public static final String IMG_DNEDITOR = "resources/icons/dneditor.png"; //$NON-NLS-1$
    public static final String IMG_SORT = "resources/icons/sort.png"; //$NON-NLS-1$
    ...
    public static final String IMG_ENTRY_EDITOR = "resources/icons/entry_editor.png"; //$NON-NLS-1$
    ...
    public static final String IMG_QUICKSEARCH = "resources/icons/quicksearch.png"; //$NON-NLS-1$
    public static final String IMG_SUBTREE = "resources/icons/subtree.png"; //$NON-NLS-1$
    public static final String IMG_SEARCH_UNPERFORMED = "resources/icons/search_unperformed.png"; //$NON-NLS-1$
    public static final String IMG_BOOKMARKS = "resources/icons/bookmarks.laksfdj"; //$NON-NLS-1$
    public static final String IMG_BOOKMARK = "resources/icons/bookmark.asdf"; //$NON-NLS-1$
    ...
    public static final String IMG_FILTER_DIT = "resources/icons/filter_dit.png"; //$NON-NLS-1$
    public static final String IMG_FILTER_EDITOR = "resources/icons/filtereditor.png"; //$NON-NLS-1$
    public static final String IMG_PARENT = "resources/icons/parent.png"; //$NON-NLS-1$
    public static final String IMG_UNFILTER_DIT = "resources/icons/unfilter_dit.png"; //$NON-NLS-1$
    public static final String IMG_FILTER = "resources/icons/filter.png"; //$NON-NLS-1$
    public static final String IMG_SORT_ASCENDING = "resources/icons/sort_ascending.png"; //$NON-NLS-1$
    public static final String IMG_SORT_DESCENDING = "resources/icons/sort_descending.png"; //$NON-NLS-1$
    public static final String IMG_VALUE_ADD = "resources/icons/value_add.png"; //$NON-NLS-1$
    public static final String IMG_ATTRIBUTE_ADD = "resources/icons/attribute_add.png"; //$NON-NLS-1$
    public static final String IMG_DELETE_ALL = "resources/icons/delete_all.png"; //$NON-NLS-1$
    ...
    public static final String IMG_OCD_ABSTRACT = "resources/icons/ocd_abstract.png"; //$NON-NLS-1$
    public static final String IMG_OCD_AUXILIARY = "resources/icons/ocd_auxiliary.png"; //$NON-NLS-1$
    public static final String IMG_OCD_STRUCTURAL = "resources/icons/ocd_structural.png"; //$NON-NLS-1$
    public static final String IMG_MRD = "resources/icons/mrd.png"; //$NON-NLS-1$
    public static final String IMG_ENTRY_WIZARD = "resources/icons/entry_wizard.png"; //$NON-NLS-1$
    public static final String IMG_TOP = "resources/icons/top.png"; //$NON-NLS-1$
