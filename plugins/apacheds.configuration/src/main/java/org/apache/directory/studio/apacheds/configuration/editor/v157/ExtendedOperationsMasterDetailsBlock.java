...
import org.apache.directory.studio.apacheds.configuration.editor.v157.dialogs.ExtendedOperationDialog;
...
public class ExtendedOperationsMasterDetailsBlock extends MasterDetailsBlock
{
    ...
    private ServerConfigurationV157 serverConfiguration;
    ...
    {
        this.page = page;
        serverConfiguration = ( ServerConfigurationV157 ) ( ( ServerConfigurationEditor ) page.getEditor() )
