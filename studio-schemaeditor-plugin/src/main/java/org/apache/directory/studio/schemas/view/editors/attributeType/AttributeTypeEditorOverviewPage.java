...
import org.apache.directory.studio.schemas.model.Syntax;
import org.apache.directory.studio.schemas.model.Syntaxes;
...
public class AttributeTypeEditorOverviewPage extends FormPage implements PoolListener
{
            ...
            if ( OID.isOID( oid ) )
            {
                ...
                else
                {
                    ...
                    oidText.setToolTipText( Messages
                        .getString( "AttributeTypeEditorOverviewPage.An_element_with_same_oid_already_exists." ) ); //$NON-NLS-1$
                }
            }
            else
            {
    ...
    private void createGeneralInformationSection( Composite parent, FormToolkit toolkit )
    {
        ...
        // SYNTAX Combo
        toolkit
            .createLabel( client_general_information, Messages.getString( "AttributeTypeEditorOverviewPage.Synatx" ) ); //$NON-NLS-1$
