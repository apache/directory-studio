        ...
        if ( inputElement instanceof ATESyntaxComboInput )
        {
            ...
            Collections.sort( children, new Comparator<Object>()
            {
                public int compare( Object o1, Object o2 )
                {
                    ...
                    {
                        return ( ( Syntax ) o1 ).getName().compareToIgnoreCase( ( ( Syntax ) o2 ).getName() );
                    }
                    else if ( o1 instanceof Syntax && o2 instanceof NonExistingSyntax )
                    {
                        return ( ( Syntax ) o1 ).getName().compareToIgnoreCase( ( ( NonExistingSyntax ) o2 ).getName() );
                    }
                    else if ( o1 instanceof NonExistingSyntax && o2 instanceof Syntax )
                    {
                        return ( ( NonExistingSyntax ) o1 ).getName().compareToIgnoreCase( ( ( Syntax ) o2 ).getName() );
                    }
