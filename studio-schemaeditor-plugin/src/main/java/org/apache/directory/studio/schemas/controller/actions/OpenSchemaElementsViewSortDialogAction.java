...
import org.apache.directory.studio.schemas.view.views.SchemaElementsViewSortDialog;
...
public class OpenSchemaElementsViewSortDialogAction extends Action
{
    ...
    {
        super( Messages.getString( "OpenSchemaElementsViewSortDialogAction.Sorting..." ) ); //$NON-NLS-1$
