...
public class SchemaElementsViewRoot extends TreeNode
{
    ...
    {
        return "SchemaElementsViewRoot"; //$NON-NLS-1$
    }
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.schemas.view.viewers.wrappers.TreeNode#addChild(org.apache.directory.studio.schemas.view.viewers.wrappers.ITreeNode)
     */
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.schemas.view.viewers.wrappers.TreeNode#addAllChildren(java.util.Collection)
     */
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.schemas.view.viewers.wrappers.TreeNode#removeChild(org.apache.directory.studio.schemas.view.viewers.wrappers.ITreeNode)
     */
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.schemas.view.viewers.wrappers.TreeNode#getChildren()
     */
