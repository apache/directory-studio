...
public interface BrowserUIConstants
{
    ...
    public static final String PERSPECTIVE_LDAP = BrowserUIPlugin.getDefault().getPluginProperties().getString(
        "Perspective_LdapPerspective_id" );
