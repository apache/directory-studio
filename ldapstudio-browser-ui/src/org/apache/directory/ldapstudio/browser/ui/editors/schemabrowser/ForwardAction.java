...
public class ForwardAction extends Action implements HistoryListener
{

    private HistoryManager historyManager;


    public ForwardAction( HistoryManager historyManager )
    {
        super.setText( "Forward" );
        super.setToolTipText( "Forward" );
    ...
    {
        super.setEnabled( this.historyManager.isForwardPossible() );
    }
