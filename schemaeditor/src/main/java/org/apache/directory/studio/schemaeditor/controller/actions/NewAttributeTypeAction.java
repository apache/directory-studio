...
public class NewAttributeTypeAction extends Action implements IWorkbenchWindowActionDelegate
{
    ...
    {
        super( Messages.getString("NewAttributeTypeAction.NewAttributeTypeAction") );
        setToolTipText( Messages.getString("NewAttributeTypeAction.NewAttributeTypeToolTip") );
