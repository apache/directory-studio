...
public abstract class AbstractWrapper implements IWrapper
{
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.proxy.view.wrappers.IWrapper#getText()
     */
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.proxy.view.wrappers.IWrapper#getImage()
     */
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.proxy.view.wrappers.IWrapper#getChildren()
     */
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.proxy.view.wrappers.IWrapper#getParent()
     */
    ...
    /* (non-Javadoc)
     * @see org.apache.directory.studio.proxy.view.wrappers.IWrapper#hasChildren()
     */
